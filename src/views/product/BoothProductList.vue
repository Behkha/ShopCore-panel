...
<v-container fill-height fluid grid-list-xl style="direction: rtl">
  <v-layout justify-center wrap>
    <v-flex md12>
      <material-card color="green" :title="' لیست محصولات غرفه '+$route.params.title" :text="`نمایش موارد ${fromItems} تا ${toItems} از ${totalItems} مورد`" hide-default-footer>
...
export default {
  ...
  methods: {
    ...
    fetchProducts() {
      this.$store.dispatch('fetchBoothProductListRequest', {
