...
<v-container fill-height fluid grid-list-xl>
  <v-layout justify-center wrap>
    <v-flex xs12 md12>
      <material-card color="green" title="ایجاد محصول" text="فیلد عنوان، قیمت، توضیحات، کتگوری، لوگو برای محصول  ضروری است">
        <v-form>
          <v-container py-0>
            <v-layout wrap>
...
export default {
  ...
  computed: {
    isSellerValid() {
      return Boolean(this.seller.name && this.seller.story)
    }
  },
  mounted() {
